...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
   ...
   $icerik = $_POST['icerik'];
            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        copy($foto, '../images/yonetim/' . $dosya_adi);
                        ...
                        $sql = "INSERT INTO yonetim SET foto=:foto, ustBaslik=:ustBaslik,baslik=:baslik,icerik=:icerik;";
                        $durum = $baglanti->prepare($sql)->execute($satir);

                        if ($durum) {
                            echo  '<div class="alert alert-success" role="alert">Yönetim Kurulu Üyesi Başarıyla Eklendi.</div>';
                        }
    ...
    if($hata!=""){
		 echo '<div class="alert alert-danger" role="alert">Yönetim Kurulu Üyesi eklenemedi.</div> '.$hata.'';
    }
}
?>
                        ...
                        <div class="module">
						   ...
						   <div class="module">
							<div class="module-head">
								<h3>Yönetim Kurulu Üye Ekle</h3>
							</div>
							<div class="module-body">
					<form method="post" action="yonetimekle.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
					<div class="control-group">
							<center>
							<div class="control-group">
											
											 <label for="foto">Yönetim Kurulu Üyesi Fotoğrafı</label>
                        ...
                        ClassicEditor
                                ...
                                .catch( error => {
										...
										<div class="control-group">
											...
											<div class="controls">
												<button type="submit" class="btn">Yönetim Kurulu Üyesi Ekle</button>
											</div>
										</div>
									</form>
