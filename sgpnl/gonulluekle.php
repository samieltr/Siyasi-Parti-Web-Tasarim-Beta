...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
  ...
  $ilce = $_POST['ilce'];
   $telefon = $_POST['telefon'];
            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        copy($foto, '../images/gonulluler/' . $dosya_adi);
                        ...
                        $sql = "INSERT INTO gonullulist SET foto=:foto, adsoyad=:adsoyad,aktif=:aktif,tckimlik=:tckimlik,il=:il,ilce=:ilce,telefon=:telefon;";
                        $durum = $baglanti->prepare($sql)->execute($satir);

                        if ($durum) {
                            echo  '<div class="alert alert-success" role="alert">Gönüllü Başarıyla Eklendi.</div>';
                        }
    ...
    if($hata!=""){
		 echo '<div class="alert alert-danger" role="alert">Gönüllü eklenemedi.</div> '.$hata.'';
    }
}
?>
<style>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span9">
					...
					<form method="post" action="gonulluekle.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
							...
							<div class="control-group">
								...
								<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="control-group">
											<label class="control-label">Gönüllü Onaylımı ?</label>
											<div class="controls">
												 <input type="checkbox" class="form-check-input" name="aktif" id="aktif">
												 <span><font color ="red">Gönüllü Telefonla Aranıp Onaylandıysa İşaretleyin.</font></span>
											</div>
										</div>
										<div class="control-group">
											
											 <label for="foto">Gönüllünün Fotoğrafı</label>
										...
										<div class="control-group">
											...
											<div class="controls">
												<button type="submit" class="btn">Gönüllü Kaydı Yap</button>
											</div>
										</div>
									</form>
