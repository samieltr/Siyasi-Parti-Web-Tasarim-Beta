...
$sorgu = $baglanti->prepare("SELECT count(*) FROM gonullulist");
$sorgu->execute();
...
$sorgu = $baglanti->prepare("SELECT count(*) FROM ilsiteleri");
$sorgu->execute();
$say = $sorgu->fetchColumn();
echo $say;
?></b>
                                        <p class="text-muted">
                                            Toplam İl Teşkilat Sitesi</p>
                                    </a>
                                </div>
                                <div class="btn-box-row row-fluid">
                                    <div class="span8">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="onaysizuyelist.php" class="btn-box small span4"><i class="icon-ok-sign"></i><b>Onay Bekleyen Üyeler</b></a>
												<a href="onayliuyelist.php" class="btn-box small span4"><i class="icon-group"></i><b>Onaylı Üyeler</b></a>
												<a href="gonullulist.php" class="btn-box small span4"><i class="icon-group"></i><b>Gönüllüler</b></a>
                                            </div>
                                        </div>
                                    </div>
